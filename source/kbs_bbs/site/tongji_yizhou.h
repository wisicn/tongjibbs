...
#define BBS_SERVICE_DICT	0   /* by wisi,no dictionary in tongji */
...
#define LIFE_DAY_NEW	        30 /*by wisi */	
#define LIFE_DAY_SUICIDE	15

#define DAY_DELETED_CLEAN	7 /*by wisi */
...
#define BBSDOMAIN_DEFAULT "yizhou.tongjibbs.org"   /* 站点域名 */
#define	SHORTNAME_DEFAULT "YIZHOU"              /* 站名简称 */
#define BBSNAME_DEFAULT   "同济一舟站"          /* 站名全称 */
#define MAILDOMAIN_DEFAULT "yizhou.tongjibbs.org"      /* 发对外邮件的地址 */
...
#define ISSUE_LOGIN		"同济大学BBS 同济一舟站"/*by wisi*/
...
attach define
*/
#define MAXATTACHMENTCOUNT	10                            //文章附件个数上限 by wisi
#define MAXATTACHMENTSIZE 2*1024*1024                     //文章附件文件长度上限 by wisi
...
#undef PERSONAL_CORP /*by wisi:force now PC */
#endif
