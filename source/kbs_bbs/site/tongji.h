...
#define BBSDOMAIN_DEFAULT "bbs.tongji.edu.cn"   /* 站点域名 */
#define	SHORTNAME_DEFAULT "TONGJI"              /* 站名简称 */
#define BBSNAME_DEFAULT   "同舟共济站"          /* 站名全称 */
#define MAILDOMAIN_DEFAULT "bbs.tongji.edu.cn"      /* 发对外邮件的地址 */
